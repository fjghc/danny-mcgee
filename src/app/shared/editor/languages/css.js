...
(function(mod) {
  ...
  CodeMirror.defineMode("css", function(config, parserConfig) {
    ...
    function wordAsValue(stream) {
      ...
      if (functionKeywords.hasOwnProperty(word))
        override = "func";
  ...
  var valueKeywords_ = [
    ...
    "arabic-indic", "armenian", "asterisks", "auto", "auto-flow", "avoid", "avoid-column", "avoid-page",
    ...
    "hiragana", "hiragana-iroha", "horizontal", "hue", "icon", "ignore",
    ...
    "progress", "push-button", "radio", "read-only",
    "read-write", "read-write-plaintext-only", "rectangle", "region",
    "relative", "repeat", "repeat-x", "repeat-y", "reset", "reverse",
    "ridge", "right", "round", "row", "row-resize", "row-reverse", "rtl", "run-in", "running",
    "s-resize", "sans-serif", "saturation", "screen",
  ...
  var lessFunctionKeywords_ = functionKeywords_.concat([
    "fade"
  ]), lessFunctionKeywords = keySet(lessFunctionKeywords_);

  var sassFunctionKeywords_ = functionKeywords_.concat([
    "red", "green", "blue", "mix", "hue", "saturation", "lightness", "adjust-hue", "lighten", "darken", "saturate", "desaturate", "grayscale",
    "complement", "invert", "alpha", "opacity", "opacify", "fade-in", "transparentize", "fade-out", "adjust-color", "scale-color", "change-color",
    "ie-hex-str", "unquote", "quote", "str-length", "str-insert", "str-index", "str-slice", "to-upper-case", "to-lower-case", "percentage",
    "round", "ceil", "floor", "abs", "min", "max", "random", "length", "nth", "set-nth", "join", "append", "zip", "index", "list-separator",
    "is-bracketed", "map-get", "map-merge", "map-remove", "map-keys", "map-values", "map-has-key", "keywords", "selector-nest", "selector-append",
    "selector-extend", "selector-replace", "selector-unify", "is-superselector", "simple-selectors", "selector-parse", "feature-exists",
    "variable-exists", "global-variable-exists", "function-exists", "mixin-exists", "content-exists", "inspect", "type-of", "unit", "unitless",
    "comparable", "call", "get-function", "if", "unique-id"
  ]), sassFunctionKeywords = keySet(sassFunctionKeywords_);

  var allWords = documentTypes_.concat(mediaTypes_).concat(mediaFeatures_).concat(mediaValueKeywords_)
    .concat(propertyKeywords_).concat(nonStandardPropertyKeywords_).concat(colorKeywords_)
    .concat(valueKeywords_).concat(functionKeywords_);
