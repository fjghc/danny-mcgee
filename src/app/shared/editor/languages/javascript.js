...
(function(mod) {
  ...
  CodeMirror.defineMode("javascript", function(config, parserConfig) {
    ...
    // loops through arguments passed in and adds each one to the context cc
    function pass() {
      for (let i = arguments.length - 1; i >= 0; i--)
        cx.cc.push(arguments[i]);
    }

    // passes along its arguments to "pass" with a null "this" and returns true
    function cont() {
